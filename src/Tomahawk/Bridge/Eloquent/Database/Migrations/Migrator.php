...
namespace Tomahawk\Bridge\Eloquent\Database\Migrations;
...
/**
 * Class Migrator
 * @package Tomahawk\Bridge\Eloquent\Database\Migrations
 */
class Migrator
{
    /**
    ...
    protected function resetMigrations(array $migrations, array $paths, $pretend = false)
    {
        ...
        $migrations = (new Collection($migrations))->map(function ($m) {
    ...
    {
        $class = Str::studlyCase(implode('_', array_slice(explode('_', $file), 4)));
