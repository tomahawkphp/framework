...
* To a bundle:
  ...
  <info>php app/hatchet doctrine:generate:entities MyCustomBundle</info>

* To a single entity:

  <info>php app/hatchet doctrine:generate:entities MyCustomBundle:User</info>
  <info>php app/hatchet doctrine:generate:entities MyCustomBundle/Entity/User</info>

* To a namespace

  <info>php app/hatchet doctrine:generate:entities MyCustomBundle/Entity</info>
...
you must provide the <comment>--path</comment> option:
  ...
  <info>php app/hatchet doctrine:generate:entities Blog/Entity --path=src/</info>
...
pass the <comment>--no-backup</comment> option:
  ...
  <info>php app/hatchet doctrine:generate:entities Blog/Entity --no-backup</info>
