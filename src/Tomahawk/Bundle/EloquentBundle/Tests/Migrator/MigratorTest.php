...
class MigratorTest extends TestCase
{
    ...
    {
        $bundles = array(
            $this->getBundle('MigrationsBundle', 'Tomahawk\Bundle\EloquentBundle\Test', $this->migrationPath),
    ...
    public function testMigrateDown()
    {
        ...
        $bundles = array($this->getBundle('MigrationsBundle', 'Tomahawk\Bundle\EloquentBundle\Test', $this->migrationPath));
    ...
    protected function getMigratorRepo($ran = array(), $last = array(), $all = array())
    {
        ...
        $migratorRepo = $this->getMockBuilder('Tomahawk\Bundle\EloquentBundle\Migrator\MigrationRepo')
    ...
    protected function getBundle($name = 'FooBarBundle', $namespace = 'Foo\BarBundle', $path = null)
    {
        ...
        $bundle = $this->createMock('Tomahawk\HttpKernel\Bundle\BundleInterface');
    ...
    {
        $controllerResolver = $this->createMock('Illuminate\Database\ConnectionResolverInterface');
