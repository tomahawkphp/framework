...
class ApplicationTest extends PHPUnit_Framework_TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        require_once self::$fixturesPath.'/ACommand.php';
        require_once self::$fixturesPath.'/BCommand.php';
    ...
    public function testRegister()
    {
        ...
        $container['http_kernel'] = new HttpKernel($eventDispatcher, $matcher, $controllerResolver);
