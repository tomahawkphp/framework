...
class HttpKernelTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function getHttpKernel()
    {
        ...
        $this->container['http_kernel'] = $httpKernel = new HttpKernel($this->container['event_dispatcher'], $matcher, $controllerResolver);
    ...
    public function testHandleWhenAnExceptionIsHandledWithASpecificStatusCode($responseStatusCode, $expectedStatusCode)
    {
        ...
        $kernel = new HttpKernel($dispatcher, new UrlMatcher(new RouteCollection(), new RequestContext()), $this->getResolver(function () { throw new \RuntimeException(); }));
